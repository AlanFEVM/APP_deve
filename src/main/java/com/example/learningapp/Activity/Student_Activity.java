...
public class Student_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int StudentNumber = lastIn.getIntExtra("student_index", -1);
        if (StudentNumber == -1) {
        ...
        String s_account = my_Data.user_data.getStudent(StudentNumber).getAccountData().getAccount_name();
        int s_age = my_Data.user_data.getStudent(StudentNumber).getAge();
        String s_name = my_Data.user_data.getStudent(StudentNumber).getName();
        String s_code = my_Data.user_data.getStudent(StudentNumber).getStudent_code();
